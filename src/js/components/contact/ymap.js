export const ymap = () => {
  (function ymapsInit(e) {
    ...
    var o = (function (e) {
        ...
        return (
          ...
          (t.prototype._resolve = function (e, n) {
            ...
            e.state < m.RESOLVING &&
              !e.resolvingPromise &&
              (e.resolvingPromise = this._resolveCore(e, n).always(
                function (n) {
    ...
    (t.modules = new o({
      ...
      fetchBundle: function (e) {
        ...
        (o.src = t.env.hosts['static'] + t.env.bundles[e]),
          ...
          o.setAttribute('data-ymaps-api-version', '2.1.79-13822025'),
          (o.async = !0);
        var i = t.vow.defer();
        return (
    ...
    enterprise: false,
    bundles: {
      full: 's3/front-maps-static/maps-front-jsapi-v2-1/2.1.79-13822025/build/release/full-e375679eab0e00a5e81ddbb027f673d8841bde2c.js',
    },
    version: '2.1.79',
    tag: '2.1.79-13822025',
    ...
    server: {
      ...
      path: 'build/release',
      params: { apikey: 'ваш API-ключ', csp: null },
      version: '2.1',
    },
    preload: { load: 'package.full', bundle: 'full' },
    token: 'd5694cb85517546912f2837d775c4d48',
    taxiInceptionBboxes: [
      [
    ...
    displayAdvert: true,
    allowYandexMapStyle: false,
    countVisiblePromo: true,
    allowDeprecatedSuggest: false,
    vector: { version: '5.21.0', ts: 1719290858491 },
    hosts: {
      api: {
    ...
    layers: {
      map: {
        version: '24.06.23-0-b240606123130',
        scaled: true,
      ...
      sat: { version: '3.1246.0' },
      sta: { version: '2024.06.24.22.13-1_24.06.22-0-20155' },
      stv: { version: '2024.06.24.22.13-1_24.06.22-0-20155' },
      trf: { version: '1719290700', scaled: true },
    ...
    geolocation: {
      ...
      span: { longitude: 171.643239, latitude: 40.700127 },
    },
  });
};
